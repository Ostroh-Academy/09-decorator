...
![UML class diagram (3)](https://github.com/Ostroh-Academy/09-decorator-AndrewYAG/assets/102692439/e57426c0-b5fa-4287-a30c-ec46ffd10f42)
ICar - Визначає інтерфейс для всіх типів автомобілів та декораторів. BasicTruck - Конкретна реалізація базового вантажного автомобіля. CarDecorator - Абстрактний клас, який представляє базовий декоратор для автомобілів. ArmorDecorator - Декоратор для додавання броні до автомобіля. ShieldDecorator - Декоратор для додавання захисного щита до автомобіля.
