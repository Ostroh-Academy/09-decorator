...
Варіант 14
Програма на C# реалізує систему бургерів з використанням паттерну "Декоратор", що дозволяє динамічно додавати інгредієнти та варіанти подачі до бургерів, змінюючи їх ціну та опис.

1. Інтерфейс Burger: Визначає методи для отримання ціни та опису бургера.

2. Клас BasicBurger: Реалізує базовий бургер з фіксованою ціною та описом.

3. Абстрактний клас BurgerDecorator: Реалізує інтерфейс Burger і служить базовим класом для всіх декораторів. Він зберігає посилання на об'єкт Burger і делегує виклики методів цьому об'єкту, дозволяючи додатковим декораторам розширювати функціональність.

4. Конкретні декоратори: Класи для додавання конкретних інгредієнтів (сир, бекон, салат, томати) та варіантів подачі (подвійний бургер, комбо-набір). Кожен декоратор додає вартість відповідного інгредієнта до загальної вартості бургера і розширює його опис.

5. Програма Program.cs: Демонструє використання декораторів для створення різних варіантів бургерів. Вона створює базовий бургер і поступово додає до нього інгредієнти, виводячи фінальну ціну та опис.

Ця програма показує, як за допомогою паттерну "Декоратор" можна створити гнучку та розширювану систему бургерів, де легко додавати нові інгредієнти та варіанти подачі, змінюючи ціну та опис бургера.
![mermaid-diagram-2024-06-03-173312](https://github.com/Ostroh-Academy/09-decorator-Viktoriia46/assets/132668579/d044989e-e083-48c2-867b-1da361ff8133)
